...
--
-- Host: 127.0.0.1    Database: ai-shifu-cook
-- ------------------------------------------------------
...
CREATE TABLE `admin_info` (
  ...
  `user_state` int NOT NULL DEFAULT '0' COMMENT 'user state',
  `user_sex` int NOT NULL DEFAULT '0' COMMENT '0-default ,1-male,2-female',
...
--
-- Dumping data for table `ai_course_lesson_generation`
--

/*!40000 ALTER TABLE `ai_course_lesson_generation` DISABLE KEYS */;
/*!40000 ALTER TABLE `ai_course_lesson_generation` ENABLE KEYS */;
...
--
-- Table structure for table `chapters_follow_up_ask_prompt`
--

DROP TABLE IF EXISTS `chapters_follow_up_ask_prompt`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `chapters_follow_up_ask_prompt` (
...
--
-- Dumping data for table `chapters_follow_up_ask_prompt`
--

/*!40000 ALTER TABLE `chapters_follow_up_ask_prompt` DISABLE KEYS */;
/*!40000 ALTER TABLE `chapters_follow_up_ask_prompt` ENABLE KEYS */;
...
--
-- Dumping data for table `chat_img`
--
...
--
-- Dumping data for table `classroom_online_count`
--

/*!40000 ALTER TABLE `classroom_online_count` DISABLE KEYS */;
/*!40000 ALTER TABLE `classroom_online_count` ENABLE KEYS */;
...
INSERT INTO `courses` VALUES (20,'ai-shifu','course1','');
...
--
-- Dumping data for table `room_msg`
--

/*!40000 ALTER TABLE `room_msg` DISABLE KEYS */;
/*!40000 ALTER TABLE `room_msg` ENABLE KEYS */;
...
--
-- Dumping data for table `user_family_mapping`
--

/*!40000 ALTER TABLE `user_family_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_family_mapping` ENABLE KEYS */;
...
--
-- Dumping routines for database 'ai-shifu-cook'
--
...
-- Dump completed on 2025-02-07 10:18:14
